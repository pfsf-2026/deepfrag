...
LEVERS = {
    ...
    "quad_contests_pg": {"label": "Quad spawns contested per game", "higher_better": True, "fmt": "num1", "levels": {3, 4},
                         ...
                         "drill": "Call the time when anyone takes it and add 60: that is the next spawn. Leave whatever you are doing 10 seconds before it with a yellow on and be at the way in 5 seconds early (the map's quad page says which). Everyone shows up to about fourteen a game; the difference is what you do when you get there."},
