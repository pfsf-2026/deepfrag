...
LEVERS = {
    ...
    "quad_contests_pg": {"label": "Quad spawns contested per game", "higher_better": True, "fmt": "num1", "levels": {3, 4},
                         ...
                         "drill": "Call the time when anyone takes it and add 60: that is the next spawn. Leave whatever you are doing 10 seconds before it with a yellow on and be at the door 5 seconds early. Everyone shows up to about fourteen a game; the difference is what you do when you get there."},
    ...
    "quad_pg": {"label": "Quads per game", "higher_better": True, "fmt": "num1", "levels": {3, 4},
                ...
                "drill": "Own the quad clock: when anyone takes it, say the time out loud and add 60. It is taken within a second of spawning nearly every time, so the next one is about a second later than the last. Be at the door 5 seconds before it with stack, and have a teammate cover the other way in."},
