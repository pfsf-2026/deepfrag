...
SYSTEM = (
    ...
    "scores, percentages, odds) MUST appear VERBATIM in the DATA, AND must stay "
    "attached to the EXACT stat, player and team it is labeled with in the DATA. "
    "Never reassign a number to a different stat, player, or team; never compute, "
    "average, sum, round, or estimate a new number; never invent players, matches or "
    "maps. If you are unsure which stat a number belongs to, describe it in words "
