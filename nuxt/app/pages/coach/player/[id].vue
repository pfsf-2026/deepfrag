<script setup>
// /coach/player/{id} — a player's coach as its own full page under the top-nav Coach entry
...
// SPA-only: served by the prerendered ssr:false shell /coach/player/_fallback/ via _redirects.
